...
from transcript_sink import app, session_manager, stats
...
async def reset_state():
    ...
    # Clear internal session state for test isolation
...
class TestHealthEndpoint:
    ...
    async def test_health_returns_healthy(self, client):
        ...
        assert data["service"] == "Teams Transcript Sink"
        assert data["version"] == "2.0.0"
        assert "timestamp" in data
    
    @pytest.mark.asyncio
    async def test_health_shows_session_status(self, client):
...
class TestStatsEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_stats_initial_values(self, client):
    ...
    @pytest.mark.asyncio
    async def test_stats_includes_queue_sizes(self, client):
    ...
    @pytest.mark.asyncio
    async def test_stats_includes_session_info(self, client):
...
class TestSessionStartEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_start_session_with_speaker_id(self, client):
    ...
    @pytest.mark.asyncio
    async def test_start_session_already_active(self, client):
...
class TestSessionEndEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_end_session_success(self, client):
    ...
    @pytest.mark.asyncio
    async def test_end_session_not_active(self, client):
        """Ending with no active session returns error."""
        response = await client.post("/session/end")
        
        assert response.status_code == 400
        data = response.json()
        assert "no active session" in data["detail"].lower()
...
class TestSessionGetEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_session_inactive(self, client):
    ...
    @pytest.mark.asyncio
    async def test_get_session_active(self, client):
...
class TestSpeakerMapEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_map_speaker_success(self, client):
    ...
    @pytest.mark.asyncio
    async def test_map_speaker_candidate(self, client):
    ...
    @pytest.mark.asyncio
    async def test_map_speaker_no_session(self, client):
...
class TestTranscriptEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_receive_v2_final_transcript(self, client):
    ...
    @pytest.mark.asyncio
    async def test_receive_v2_partial_transcript(self, client):
    ...
    @pytest.mark.asyncio
    async def test_receive_v1_recognized_transcript(self, client):
    ...
    @pytest.mark.asyncio
    async def test_receive_session_started_event(self, client):
    ...
    @pytest.mark.asyncio
    async def test_receive_session_stopped_event(self, client):
    ...
    @pytest.mark.asyncio
    async def test_receive_error_event(self, client):
    ...
    @pytest.mark.asyncio
    async def test_transcript_updates_stats(self, client):
    ...
    @pytest.mark.asyncio
    async def test_transcript_adds_to_active_session(self, client):
    ...
    @pytest.mark.asyncio
    async def test_transcript_v1_normalization(self, client):
...
class TestIntegrationFlow:
    ...
    @pytest.mark.asyncio
    async def test_full_interview_flow(self, client):
        ...
        transcripts = [
            ...
            ("speaker_1", "I have 5 years of Python experience in backend development."),
            ("speaker_0", "What testing frameworks have you used?"),
            ("speaker_1", "I primarily use pytest with fixtures and parametrized tests."),
        ]
    ...
    @pytest.mark.asyncio
    async def test_multiple_sessions_sequential(self, client):
    ...
    @pytest.mark.asyncio
    async def test_transcripts_without_session(self, client):
